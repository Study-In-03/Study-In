...
- v4에서 공통 변수 지정 및 테마 확장 방식이 변경됨에 따라 발생할 수 있는 팀원 간의 설정 혼선을 방지하고, 모두가 동일하고 안정적인 개발 환경에서 협업하기 위함 <br>
...
<img width="500" alt="Image" src="https://github.com/user-attachments/assets/9dd6e1bb-0dd8-43da-81b5-6f871794fdd2" />

- **브랜치 전략 작성 및 적용** <br>

    - 프로젝트의 안정성과 병렬 개발을 위해 Git-flow 모델을 기반으로 운영

<img width="500" alt="Image" src="https://github.com/user-attachments/assets/a12513b2-a29e-41d0-95ff-54db36470b0f" />

- **커밋 메시지 규칙 (Commit Convention) 확립** <br>

    - `Prefix: #이슈번호 - 작업내용` 형식 준수 및 Git-flow 적용

<img width="400" alt="Image" src="https://github.com/user-attachments/assets/f6865e11-fc97-413a-86e4-c428120b2a66" />
<img width="500" alt="Image" src="https://github.com/user-attachments/assets/74541be5-178b-417a-8a90-6fdf5dbd066d" />
<img width="165" alt="Image" src="https://github.com/user-attachments/assets/d60d9dca-fd87-46e6-ada0-9dea37369110" />
...
<img width="700" alt="Image" src="https://github.com/user-attachments/assets/f4b7f171-dc45-4774-89da-bb6b16218839" />
<img width="700" alt="Image" src="https://github.com/user-attachments/assets/841b88c3-0111-485a-862f-73cd83110a9b" />
<img width="210" height="42" alt="Image" src="https://github.com/user-attachments/assets/eb10e20d-a070-496d-ba06-de11b7faf88b" />
...
<img width="700" alt="Image" src="https://github.com/user-attachments/assets/2fc39b83-fba4-47a6-8744-bd9f67da50f6" />
...
- **AI 코드 컨벤션** <br>
    ...
    <img width="500" alt="Image" src="https://github.com/user-attachments/assets/ab8bd77e-f41b-4652-a9f6-27d4e389a0c2" />
    <img width="500" alt="Image" src="https://github.com/user-attachments/assets/087547c0-4204-4ccb-b434-4c489eea0a0d" />
...
<img width="500" alt="Image" src="https://github.com/user-attachments/assets/467c842d-ca62-4488-8968-7bf60d24d3c0" />
<img width="500" alt="Image" src="https://github.com/user-attachments/assets/bfa58db9-b25f-4702-9ff2-24e960b1c87d" />

<br>

<img width="1000" alt="Image" src="https://github.com/user-attachments/assets/5b5629e6-34f2-4f36-bc19-2f452f2cdf0b" />

- **팀원을 위한 가이드 wiki 작성** <br>

<img width="500" alt="Image" src="https://github.com/user-attachments/assets/c9a05408-e13a-4851-a938-0c3aee836276" />

<br>

<img width="333" alt="Image" src="https://github.com/user-attachments/assets/691d04c5-5b53-4e01-a4f6-27ac53eaadc3" />
...
### 1. 데이터 기반의 맞춤형 AI 큐레이션 고도화

현재는 사용자가 입력한 정보를 바탕으로 커리큘럼을 '생성'하는 수준 <br>
향후에는 사용자의 학습 데이터를 활용한 큐레이션으로 확장 계획

**학습 이력 기반 추천**
- 사용자가 참여했던 스터디 주제와 난이도 데이터를 분석하여 차기 스터디를 추천하는 알고리즘을 도입

**AI 스터디 가이드**
- 현재의 커리큘럼 생성을 넘어, 스터디 진행 상황에 맞춰 AI가 매주 학습 퀴즈를 생성하거나 요약본을 제공하는 'AI 학습 비서' 기능을 추가

### 2. 게이미피케이션(Gamification)을 통한 커뮤니티 활성화

현재 API에는 유저의 '등급(Grade)' 필드가 이미 존재

**활동 포인트 시스템**
- 스터디 참가, 댓글 작성, 좋아요 클릭 등의 활동에 포인트를 부여하고, 이에 따라 등급이 상승하는 시스템을 활성화

**신뢰도 배지**
- 신고 시스템과 연동하여 매너 있는 학습자에게는 특별한 배지를 부여함으로써, 자정 작용이 일어나는 건강한 학습 커뮤니티로 발전시킬 계획

### 3. 실시간 협업 도구의 통합 (Full-Stack 협업 플랫폼)

현재의 웹소켓 채팅은 시작일 뿐이다. <br>

**실시간 화상 및 화면 공유**
- 텍스트 채팅을 넘어 WebRTC 기술을 접목한 화상 회의 기능을 통합

**공동 문서 편집**
- 스터디 멤버들이 실시간으로 학습 노트를 기록하고 파일을 공유하는 협업 캔버스 기능을 추가
- 외부 툴 없이도 스터디의 모든 과정이 플랫폼 내에서 완결되도록 확장 가능

### 4. 소셜 로그인을 통한 접근성 및 유저 확장

현재 API 명세에는 카카오, 구글, 깃허브 등 다양한 소셜 로그인 식별자(UID) 구조가 이미 마련

**간편 인증 도입**
- 추후 소셜 로그인 기능을 활성화하여 신규 유저의 진입 장벽을 낮추고, 깃허브(GitHub) 데이터 연동을 심화하여 개발자 지망생들에게 특화된 '기술 스택 기반 매칭' 서비스를 강화
...
<img src="https://github.com/user-attachments/assets/685c41b9-9d87-4f30-bdca-e18b7c32ad64" width="100" style="border-radius:50%; border:1px solid black">
...
<img src="https://github.com/user-attachments/assets/c38a9e7d-93f7-4ec2-b72c-0928ac09b14f" width="100" style="border-radius:50%; border:1px solid black">
...
<img src="https://github.com/user-attachments/assets/f04c52b2-602c-4c65-b403-e9fa5444e4b1" width="100" style="border-radius:50%; border:1px solid black">
...
<img src="https://github.com/user-attachments/assets/e4508510-dcda-44a2-aa21-646e9cd86200" width="100" style="border-radius:50%; border:1px solid black">
...
<img src="https://github.com/user-attachments/assets/6e38fe3d-4314-4e12-b93d-284e82f291cf" width="100" style="border-radius:50%; border:1px solid black">
...
<img src="https://github.com/user-attachments/assets/bdb12ad6-16ca-46e8-a82c-4ea992ebbba4" width="100" style="border-radius:50%; border:1px solid black">

**최서원**

**(팀원)** | <https://github.com/swlog> | <seowonc123@gmail.com>
