...
export default function StudyList({ selectedCategory, searchTerm }: { selectedCategory: string, searchTerm: string }) {
  // 훅을 통해 진짜 데이터를 받아옵니다.
  const { studies, isLoading, error } = useStudyList(selectedCategory, searchTerm); 
